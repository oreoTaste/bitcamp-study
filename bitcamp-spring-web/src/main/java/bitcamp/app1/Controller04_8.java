...
public class Controller04_8 {
  ...
  // => Part또는 MultipartFile 타입의 아규먼트를 선언하면 된다.
  //
  // 주의!
  ...
  @ResponseBody
  public String handler1(String name, int age, Part photo) throws Exception {
  ...
  @ResponseBody
  public String handler3(String name, int age, MultipartFile[] photo) throws Exception {
    // 배열로 받기
