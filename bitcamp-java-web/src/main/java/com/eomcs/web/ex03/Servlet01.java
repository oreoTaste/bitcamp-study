...
@WebServlet("/ex03/s01") // http://localhost:9999/bitcamp-java-web/ex03/s01로 접속가능
public class Servlet01 extends GenericServlet {
  
  private static final long serialVersionUID = 1L; // GeneralServlet이 Serializable을 상속받는다.
