...
CREATE TABLE t_students (
  ...
  final_education VARCHAR(30)  NOT NULL COMMENT '최종학력', -- 최종학력
  major           VARCHAR(30)  NOT NULL COMMENT '전공', -- 전공
  school_name     VARCHAR(30)  NOT NULL COMMENT '최종학교명', -- 최종학교명
  working         INTEGER      NOT NULL COMMENT '재직여부', -- 재직여부
  account         VARCHAR(20)  NULL     COMMENT '통장번호', -- 통장번호
  bank            VARCHAR(30)  NULL     COMMENT '은행명' -- 은행명
)
COMMENT '학생';
...
CREATE TABLE t_managers (
  ...
  photo     VARCHAR(255) NULL     COMMENT '사진', -- 사진
  position  VARCHAR(30)  NOT NULL COMMENT '직위', -- 직위
...
CREATE TABLE t_lesson_room (
  ...
  center         VARCHAR(30) NOT NULL COMMENT '강의센터', -- 강의센터
...
CREATE TABLE t_lesson_teachers (
  lesson_teacher_no INTEGER NOT NULL COMMENT '강의강사번호', -- 강의강사번호
  lesson_no         INTEGER NOT NULL COMMENT '강의번호', -- 강의번호
  teacher_no        INTEGER NOT NULL COMMENT '회원번호' -- 회원번호
)
COMMENT '강의강사';
